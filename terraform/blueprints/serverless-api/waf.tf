...
resource "aws_wafv2_web_acl_association" "api" {
  ...
  resource_arn = "arn:aws:apigateway:${data.aws_region.current.name}::/restapis/${aws_api_gateway_rest_api.this[0].id}/stages/${aws_api_gateway_stage.this[0].stage_name}"
